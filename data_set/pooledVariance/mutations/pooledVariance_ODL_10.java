...
public class pooledVariance_ODL_10
{

    public static  double pooledVariance_ODL_10( java.lang.Double[] data1, java.lang.Double[] data2 )
    {
        double sum1 = 0;
        double sumSq1 = 0;
        ...
        double var1 = (sumSq1 - mean1) / data1.length;
        double sum2 = 0;
        double sumSq2 = 0;
