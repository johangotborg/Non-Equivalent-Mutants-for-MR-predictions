...
public class pooledVariance_ODL_11
{

    public static  double pooledVariance_ODL_11( java.lang.Double[] data1, java.lang.Double[] data2 )
    {
        double sum1 = 0;
        double sumSq1 = 0;
        ...
        double var1 = (sumSq1 - sum1) / data1.length;
        double sum2 = 0;
        double sumSq2 = 0;
