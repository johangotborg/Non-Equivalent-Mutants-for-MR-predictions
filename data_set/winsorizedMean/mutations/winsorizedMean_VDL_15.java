...
public class winsorizedMean_VDL_15
{

    public static  double winsorizedMean_VDL_15( java.lang.Double[] sortedElements, java.lang.Integer left, java.lang.Integer right )
    {
        ...
        for (int i = 0; i < right; ++i) {
            mean += (rightElement - sortedElements[1 - i]) / N;
        }
        return mean;
    }
