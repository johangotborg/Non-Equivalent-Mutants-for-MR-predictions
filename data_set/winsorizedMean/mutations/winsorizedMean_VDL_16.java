...
public class winsorizedMean_VDL_16
{

    public static  double winsorizedMean_VDL_16( java.lang.Double[] sortedElements, java.lang.Integer left, java.lang.Integer right )
    {
        ...
        for (int i = 0; i < right; ++i) {
            mean += (rightElement - sortedElements[N - 1]) / N;
        }
        return mean;
    }
