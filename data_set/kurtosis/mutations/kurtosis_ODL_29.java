...
public class kurtosis_ODL_29
{

    public static  double kurtosis_ODL_29( java.lang.Double[] data )
    {
        double sum = 0;
        double sumPD = 0;
        double sumSq = 0;
        ...
        return -3 + moment4 / (standardDeviation * standardDeviation * standardDeviation);
    }
